...
\includegraphics[width=2\textwidth,height=6cm,keepaspectratio]{images/Modelo de Contexto.jpg}
\newpage
\subsection{Modelo de Caso de Uso}

\subsubsection{Diagrama de Casos de Uso (visão resumida)}
\includegraphics[width=1.25\textwidth,height=10cm,keepaspectratio]{images/Caso de Uso.jpg}
...
\includegraphics[width=9\textwidth,height=7cm,keepaspectratio]{images/Modelo de Sequencia.png}

\subsection{Modelo de Classes}
\includegraphics[width=9\textwidth,height=7cm,keepaspectratio]{images/Modelo de Classes.png}
\subsubsection{Modelo de Classes - Integrações do Sistema}
\includegraphics[width=1.3\textwidth,height=7cm,keepaspectratio]{images/Modelo de Classes - Intergrações.png}
...
\includegraphics[width=1.4\textwidth,height=7cm,keepaspectratio]{images/Modelo de Implatação.jpg}
